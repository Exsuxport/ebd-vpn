...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Name       EXSU 'Open Source Information Facebook'
    CodeName   EZX
    version    full version
    Team       Exsuxteam Security
    Email      islammaruf691@gmail.com
...
def bot():
  try:
	...
	cek = raw_input(R + 'OREXY' + W +'/' + R +'Bot ' + W + '>> ')
